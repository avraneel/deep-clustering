...
def pre_train(dec):
      ...
      plt.savefig(fname='./results/pre_train_exp_digits.png', format='png')
...
PATH = './saved_models/pre_trained_exp_digits.pth'
...
def train(dec):
      ...
      plt.ylabel('Loss')
      plt.plot(train_loss)
      plt.savefig(fname='./results/train_exp_digits.png', format='png')
...
with open("./results/e_digits.txt", "a") as o:
