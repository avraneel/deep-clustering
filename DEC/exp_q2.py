...
def pre_train(dec):
      ...
      plt.savefig(fname='./results/pre_train_q2.png', format='png')

pre_train(dec)

# Saving and Loading

PATH = './saved_models/pre_trained_q2.pth'
...
def train(dec):
      ...
      plt.ylabel('Loss')
      plt.plot(train_loss)
      plt.savefig(fname='./results/train_q2.png', format='png')
...
with open("./results/q2.txt", "a") as o:
...
plt.savefig(fname='./results/TSNE_q2_' + str(n_train) + '_epochs.png', format='png')
plt.show()